        ...
        <div className="w-full h-[28.5px] flex items-center shrink-0">
          ...
          <div className="flex-1 flex-row gap-[7px] basis-0 h-full flex items-center justify-end shrink-0">
            ...
            <button
              ...
              className="bg-[#F1F1F1] flex-row gap-[5px] flex items-center justify-center rounded-full text-black text-[10.25px] tracking-[1%] aspect-square h-[28.5px] font-[family-name:var(--font-plus-jakarta-sans)] font-regular cursor-pointer hover:bg-[#e5e5e5] transition-colors"
            >
              <img
